...
public class viewdetailDoc extends JFrame {
    ...
    private void initializeUI() {
        setTitle("Hospital Management System - Doctor Records");
    ...
    private JPanel createHeaderPanel() {
        ...
        // Title section
        JLabel titleLabel = new JLabel("Doctor Records");
    ...
    private void setupTable() {
        String[] columns = {"ID", "Doctor Name", "Specialization"};
    ...
    private void updateStatistics() {
        try {
            try (PreparedStatement pstmt = connection.prepareStatement(
                    "SELECT COUNT(*) FROM doctor_record")) {
                ResultSet rs = pstmt.executeQuery();
                if (rs.next()) {
